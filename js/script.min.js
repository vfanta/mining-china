...
$(document).ready(function () {
    ...
    //
    //     $.ajax({
    //         url: '//formspree.io/vfanta1@gmail.com',
    //         method: 'POST',
    //         data: $(this).serialize(),
    //         dataType: 'json',
    //         beforeSend: function () {
    //             $contactForm.append('<div class="alert alert--loading">Сообщение отрпавляется…</div>');
    //             $('.alert--loading').fadeIn(1000).fadeOut(1000, function () {
    //                 $(this).remove()
    //             });
    //         },
    ...
    //             //$('.alert--succes').hide();
    //             $('.alert--succes').fadeIn(1000).fadeOut(5000, function () {
    //                 $(this).remove()
    //             });
    //
    //         },
    ...
    //             //$('.alert--error').hide();
    //             $('.alert--error').fadeIn(1000).fadeOut(5000, function () {
    //                 $(this).remove()
    //             });
    //
    //         }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        contactForm.addEventListener('submit', function(event) {
            ...
            fetch('//formspree.io/vfanta1@gmail.com', {
                method: 'post',
                mode: 'cors',
